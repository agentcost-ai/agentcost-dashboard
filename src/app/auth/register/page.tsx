...
export default function RegisterPage() {
  ...
  const handleSubmit = async (e: React.FormEvent) => {
    ...
    try {
      // register() stores tokens exactly like login and saves the default
      // project's API key (shown only once) — no "check your email" gate.
      await register({
        email,
        password,
        name: name || undefined,
        accept_terms: acceptPolicies,
        accept_privacy: acceptPolicies,
      ...
      // (register() itself already leaves demo mode).
  ...
  return (
    <div className="w-full max-w-100 px-6 py-16">
      ...
      {/* OAuth (only rendered when configured) */}
      {GOOGLE_CONFIGURED && (
      ...
      <form onSubmit={handleSubmit} className="space-y-5">
        ...
        {/* Legal Consent — single combined checkbox */}
        <div className="pt-1">
        ...
        <button
          type="submit"
          disabled={isLoading || !allRequirementsMet || !acceptPolicies}
