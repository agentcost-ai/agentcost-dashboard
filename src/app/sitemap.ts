...
export default function sitemap(): MetadataRoute.Sitemap {
  ...
  const staticRoutes: MetadataRoute.Sitemap = [
    ...
    { url: `${BASE_URL}/docs`, lastModified: lastmod, changeFrequency: "monthly", priority: 0.8 },
    ...
    { url: `${BASE_URL}/about`, lastModified: lastmod, changeFrequency: "yearly", priority: 0.6 },
    { url: `${BASE_URL}/contact`, lastModified: lastmod, changeFrequency: "yearly", priority: 0.6 },
